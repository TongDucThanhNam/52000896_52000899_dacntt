...
export interface ITransactionService {
    ...
    getUserTransactions(data: any): Promise<typeof TransactionWithBase[] | null>;

    getTransactionItems(data: any): Promise<typeof TransactionItemWithBase[] | null>;

    updateTransactionStatus(data: any): Promise<typeof TransactionWithBase | null>;
}