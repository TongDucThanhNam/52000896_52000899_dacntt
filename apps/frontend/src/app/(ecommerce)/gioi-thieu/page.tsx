          ...
          <div className="space-y-8">
            <section className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Chúng tôi là cửa hàng thương mại điện tử chuyên cung cấp các sản
            ...
            <section className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Được thành lập từ năm 2020, chúng tôi đã không ngừng phát triển
                và mang đến cho khách hàng những trải nghiệm mua sắm tốt nhất.
              </p>
            </section>
            ...
            <section className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Sứ mệnh của chúng tôi là mang lại sự hài lòng tuyệt đối cho
                khách hàng thông qua chất lượng sản phẩm và dịch vụ.
              </p>
            </section>
          </div>
        </div>
