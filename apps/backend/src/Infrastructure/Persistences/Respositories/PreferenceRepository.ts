...
class PreferenceRepository implements IPreferenceRepository {
  ...
  async createPreference(preferenceData: any): Promise<any> {
    try {
      ...
      throw new Error(
        `Error at PreferenceRepository.createPreference: ${error}`,
      );
    }
  }
  ...
  async getPreferenceById(preferenceId: string, queryData: any): Promise<any> {
    try {
      const preference: any = await this.db
        .select()
        .from(preferences)
      ...
      throw new Error(
        `Error at PreferenceRepository.getPreferenceById: ${error}`,
      );
    }
  }
  ...
  async updatePreferenceById(
    ...
    try {
      ...
      throw new Error(
        `Error at PreferenceRepository.updatePreferenceById: ${error}`,
      );
    }
  }
  ...
  async deletePreferenceById(preferenceId: string): Promise<any> {
    try {
      ...
      throw new Error(
        `Error at PreferenceRepository.deletePreferenceById: ${error}`,
      );
    }
  }
  ...
  async getPreferencesByUserId(userId: string, queryData: any): Promise<any> {
    try {
      const preferencesResult: any = await this.db
        .select()
        .from(preferences)
        .where(eq(preferences.userId, Number(userId)));
      return preferencesResult;
    } catch (error) {
      throw new Error(
        `Error at PreferenceRepository.getPreferencesByUserId: ${error}`,
      );
    }
  }
}
