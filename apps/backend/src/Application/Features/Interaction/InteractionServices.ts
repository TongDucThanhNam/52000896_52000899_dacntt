...
class InteractionServices implements IInteractionServices {
  ...
  // Interactions
  async getProductInteractions(data: any): Promise<any> {
    try {
      const queryData = {
        productId: data,
        isDeleted: false,
      ...
      throw new Error(
        `Error at InteractionServices.getProductInteractions: ${error}`,
      );
    }
  }

  async getUserInteractions(data: any): Promise<any> {
    try {
      const queryData = {
        userId: data,
        isDeleted: false,
      ...
      throw new Error(
        `Error at InteractionServices.getUserInteractions: ${error}`,
      );
    }
  }
  ...
  async getUserLogs(data: any): Promise<any> {
    try {
      ...
      throw new Error(`Error at InteractionServices.getUserLogs: ${error}`);
    }
  }
